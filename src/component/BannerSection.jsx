...
const BannerSection = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 gap-2 h-screen p-0">
      {/* Left-side Banner */}
      <motion.div 
        className="relative col-span-3 bg-gray-200 bg-cover bg-center"
        style={{ 
      ...
      >
        <a href="/collections/t-shirt" className="flex items-center justify-center h-full">
          <div className="font-semibold text-2xl text-white text-center p-2">
            CARDIGANS & JACKETS
          </div>
        </a>
      </motion.div>
      ...
      {/* Right-side Grid for 4 Small Banners */}
      <div className="grid grid-rows-2 grid-cols-2 gap-2 col-span-2 p-0">
        {/* First small banner - Pants */}
        <motion.div
          className="relative bg-gray-200 bg-cover bg-center h-full"
          style={{ backgroundImage: "url(//zed.com.pk/cdn/shop/files/0L0A8388_1920x_crop_center.jpg?v=1618302398)" }}
        ...
        >
          <a href="/collections/pants" className="flex items-center justify-center h-full">
            <div className="font-semibold text-base text-white text-center p-2">
              PANTS
            </div>
          </a>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-center w-full h-full text-center p-2">
            <div className="font-semibold text-base text-white" style={{ fontSize: '22px' }}>
              T-SHIRT
            </div>
          </div>
        </motion.a>
