        ...
        <div className="space-y-4">
          {cartItems.map(item => (
            <div
              ...
              className="flex flex-col sm:flex-row items-center bg-white p-4 shadow-md rounded-lg border"
            >
              <img
                src={item.image}
                alt={item.title}
              ...
              <div className="flex-1 text-center sm:text-left sm:ml-4">
                ...
                <p className="text-gray-500 text-sm mb-1">Size: <span className="font-medium">{item.size}</span></p>
              ...
              <button
                ...
                className="mt-3 sm:mt-0 sm:ml-4 bg-gray-300 px-4 py-2 rounded-lg hover:bg-gray-400 transition"
              >
                Remove
              </button>
            </div>
